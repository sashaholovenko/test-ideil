...
const TeamAboutGame = () => {
    return (
        <div className="team-games-about">
            ...
            <div className="team-games-about__expand">
            <b className="team-games-about__button">РАЗВЕРНУТЬ</b>
            </div>



            <div className="team-games-questions">
                <h2>Частые вопросы</h2>
                <div className="teams-games-questions__item">
